        ...
        <table>
          <thead className="text-md font-bold w-full text-center">
            <tr>
              ...
              <th className="bg-black/50 text-white py-3 w-40">Locked LXM</th>
              <th className="bg-black/50 text-white py-3 w-40">Claimed LXM</th>
              <th className="bg-black/50 text-white py-3 w-40">Remaining</th>
              {/* <th className="bg-black/50 text-white py-3 w-40">Rate</th> */}
              {/* <th className="bg-black/50 text-white py-3 w-40">Hash</th> */}
              <th className="bg-black/50 text-white py-3 w-40">INR</th>
              <th className="bg-black/50 text-white py-3 w-40">Payout</th>
          ...
          <tbody className="w-full text-center">
            {tableData.map((data) => (
              <tr key={data.id}>
                ...
                <td className="py-1 hover:bg-black/20 w-40">{data.etherAmount==0?data.USDTAmount:data.etherAmount} {data.etherAmount==0?"USDT":"MATIC"}</td>
